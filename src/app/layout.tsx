// Root layout for the entire application. Wraps all pages in the SessionProvider
// (for NextAuth session management), ThemeProvider (for dark/light mode), and
// renders the global navigation bar with auth-aware user menu.
// This file also defines the site metadata, sticky header, and footer.
              ...
              <div className="container mx-auto px-4 md:px-6 h-16 flex items-center justify-between max-w-7xl">
                <div className="flex items-center gap-6 md:gap-10">
                  ...
                  <nav className="flex gap-1 md:gap-2">
                    ...
                    <Link href="/book" className="px-3 py-2 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-zinc-800/50 transition-colors">Book</Link>
                  </nav>
                </div>

// Booking success confirmation page. Displayed after a patient successfully submits
// a new appointment. Shows a confirmation message, the booking reference ID, and
// provides an "Add to Calendar" button that downloads an .ics file generated by
// the /api/appointments/[id]/calendar endpoint. Wrapped in a Suspense boundary
// because it uses useSearchParams() for the appointment ID.
'use client';
